...
MacUpdateFile="update-mac-x64-$AppVersion"
ARMacUpdateFile="update-mac-arm-$AppVersion"
MacSetupFile="tdx-mac.$AppVersionStrFull.dmg"
MacRemoteFolder="tmac"
WinDeployPath="$BackupPath/$AppVersionStrMajor/$AppVersionStrFull/tsetup"
WinUpdateFile="update-win-x86-$AppVersion"
WinSetupFile="tdx-win-x86.$AppVersionStrFull.exe"
WinPortableFile="tdx-portable-win-x86.$AppVersionStrFull.zip"
WinRemoteFolder="tsetup"
Win64DeployPath="$BackupPath/$AppVersionStrMajor/$AppVersionStrFull/tx64"
Win64UpdateFile="update-win-x64-$AppVersion"
Win64SetupFile="tdx-win-x64.$AppVersionStrFull.exe"
Win64PortableFile="tdx-portable-win-x64.$AppVersionStrFull.zip"
...
LinuxUpdateFile="update-linux-x64-$AppVersion"
LinuxSetupFile="tdx-linux-x64.$AppVersionStrFull.tar.xz"
